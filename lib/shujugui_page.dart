...
class ShujuguiPage extends StatefulWidget {
  ...
  const ShujuguiPage({super.key, required this.levelId});
  @override
        ...
        child: Stack(
          children: [
            ...
            Column(mainAxisSize: MainAxisSize.min, children: [
              Row(children: [Icon(Icons.storage, size: 16, color: color), const SizedBox(width: 8), Text("// CABINET_CHANNEL", style: TextStyle(color: color.withValues(alpha: 0.6), fontSize: 10, fontFamily: 'monospace', letterSpacing: 2)), const Spacer(), Text("SESSION", style: TextStyle(color: color.withValues(alpha: 0.6), fontSize: 10, fontFamily: 'monospace', letterSpacing: 2))]),
              const SizedBox(height: 12),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFE26CFF).withValues(alpha: 0.6)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: const [
                    Icon(Icons.storage, size: 12, color: Color(0xFFE26CFF)),
                    SizedBox(width: 4),
                    Text('封存', style: TextStyle(color: Color(0xFFE26CFF), fontSize: 9, fontFamily: 'monospace')),
                  ],
                ),
              ),
            ),
