...
class _JiaoyidianPageState extends State<JiaoyidianPage> {
  ...
  Widget _buildHeader(Color color) {
    return Column(
      children: [
        Text('交易点', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 8, fontFamily: 'monospace', shadows: [Shadow(color: color, blurRadius: 20)])),
        const SizedBox(height: 12),
