...
class RestStopScreen extends StatelessWidget {
  ...
  const RestStopScreen({super.key, required this.levelId});
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.hotel, size: 16, color: color),
                  const SizedBox(width: 8),
                  Text("// REST_CHANNEL", style: TextStyle(color: color.withValues(alpha: 0.6), fontSize: 10, fontFamily: 'monospace', letterSpacing: 2)),
                  const Spacer(),
                  Text("SESSION", style: TextStyle(color: color.withValues(alpha: 0.6), fontSize: 10, fontFamily: 'monospace', letterSpacing: 2)),
                ],
              ),
              const SizedBox(height: 12),
...
Widget _buildHeader() {
  return Column(
    children: const [
      Text('歇脚点', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 8, fontFamily: 'monospace', shadows: [Shadow(color: Color(0xFF6CE4FF), blurRadius: 20)])),
      SizedBox(height: 12),
      Text('REST STOP v3.4', style: TextStyle(fontSize: 10, color: Color(0x666CE4FF), letterSpacing: 2, fontFamily: 'monospace')),
    ],
  );
}
